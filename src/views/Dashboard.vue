    ...
    <v-row>
      ...
      <v-col cols="12" lg="4">
        ...
        >
          ...
          <p class="d-inline-flex font-weight-light mb-0">Last Campaign Performance</p>
      ...
      <v-col cols="12" lg="4">
        ...
        >
          ...
          <p class="d-inline-flex font-weight-light mb-0">Last Last Campaign Performance</p>
            ...
            <v-tab-item v-for="n in 3" :key="n">
              <v-list three-line class="py-0">
                <v-list-item @click="complete(0)">
                  ...
                  <v-list-item-title>Sign contract for "What are conference organized afraid of?"</v-list-item-title>

                  <div class="d-flex">
                    <v-tooltip top content-class="top">
                      <template v-slot:activator="{ attrs, on }">
                        <v-btn class="v-btn--simple" color="green" icon v-bind="attrs" v-on="on">
                    ...
                    <v-tooltip top content-class="top">
                      <template v-slot:activator="{ attrs, on }">
                        <v-btn class="v-btn--simple" color="danger" icon v-bind="attrs" v-on="on">
